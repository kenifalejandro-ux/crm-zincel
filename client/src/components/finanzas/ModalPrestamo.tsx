  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
      <div className={`${MODAL_BASE} w-full max-w-lg p-6 space-y-4 max-h-[90vh] overflow-y-auto`}>
        <div>
          <h2 className="text-base font-semibold text-zinc-200">Registrar préstamo</h2>
          <p className="text-xs text-zinc-400 mt-0.5">Dinero que recibiste prestado y debes devolver</p>
        </div>

        {/* Categoría */}
        <div>
          <label className="text-xs font-medium text-gray-300 mb-1 block">¿Para qué fue el préstamo?</label>
        ...
        {/* Descripción */}
        <div>
          <label className="text-xs font-medium text-gray-300 mb-1 block">Detalle del préstamo</label>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="col-span-2">
            <label className="text-xs font-medium text-gray-300 mb-1 block">Monto prestado</label>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <label className="text-xs font-medium text-gray-300 mb-1 block">Fecha del préstamo</label>
