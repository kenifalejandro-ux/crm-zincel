  ...
  return (
    <div>
      ...
      <input
        ...
        step="0.01"
        min="0"
        className="w-full border border-zinc-200 rounded-lg px-3 py-1.5 text-xs focus:outline-none focus:border-zinc-400"
      />
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl my-4">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="text-[11px] font-medium text-zinc-600 block mb-1">Fecha de cierre *</label>
              <input
                type="date"
          ...
          {/* Activos corrientes */}
          <div>
            <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-3">Activos Corrientes</p>
          ...
          <div>
            <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-3">Activos No Corrientes</p>
            <div className="grid grid-cols-2 gap-3">
          ...
          {/* Pasivos */}
          <div>
            <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-3">Pasivos</p>
            <div className="grid grid-cols-2 gap-3">
          ...
          {/* Resultados */}
          <div>
            <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-3">Resultados</p>
            <div className="grid grid-cols-3 gap-3">
          ...
          {/* Notas */}
          <div>
            <label className="text-[11px] font-medium text-zinc-600 block mb-1">Notas</label>
            <textarea
              value={form.notas}
