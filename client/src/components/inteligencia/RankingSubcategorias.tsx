  ...
  return (
    <div className={`${CARD_CLASS} space-y-5`}>
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <p className="text-[11px] font-semibold text-zinc-300 uppercase tracking-wider">Ranking por subcategoría</p>
      ...
      <div style={{ height: Math.max(160, datos.length * 36) }}>
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData} layout="vertical" margin={{ top: 0, right: 40, left: 10, bottom: 0 }}>
            ...
            <YAxis type="category" dataKey="name" tick={{ fontSize: 11, fill: "#71717a" }} width={110} />
            <Tooltip
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-white/[0.08]">
              ...
              <th className="text-left py-2 pr-2 text-zinc-500 font-medium">Categoría</th>
              <th className="text-center py-2 pr-2 text-zinc-500 font-medium">Total</th>
          ...
          <tbody>
            {datos.map((r, i) => {
              ...
              return (
                <tr key={i} className="border-b border-white/[0.05] hover:bg-zinc-800/40 transition">
