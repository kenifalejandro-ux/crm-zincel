  ...
  return (
    <div className={`${CARD_CLASS} space-y-5`}>
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <p className="text-[11px] font-semibold text-zinc-500 uppercase tracking-wider">Ranking por subcategoría</p>
            ...
            {datos.map((r, i) => {
              ...
              return (
                <tr key={i} className="border-b border-zinc-50 hover:bg-zinc-50 transition">
                  ...
                  <td className="py-2.5 pr-2 text-center font-semibold text-zinc-800">{r.total}</td>
                  <td className="py-2.5 pr-2 text-center text-zinc-600">{r.activas}</td>
