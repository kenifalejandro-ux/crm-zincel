            ...
            <>
              ...
              <div className="max-h-48 overflow-y-auto space-y-1.5">
                {preview.campanas.map((c: any, i: number) => (
                  <div key={i} className="flex items-center justify-between px-3 py-2 bg-zinc-50 rounded-lg text-xs">
              ...
              <div className="flex gap-2">
                <button onClick={() => { setPaso("plataforma"); setPreview(null); setError(null); }}
                  className="flex-1 py-2.5 border border-zinc-200 text-zinc-600 text-xs font-medium rounded-lg hover:bg-zinc-50 transition">
                  Volver
                </button>
