/** client/src/components/dashboard/ActividadMensualDiaria.tsx — NEON
 * Antes: chips de serie inactivos bg-slate-800/60, selects focus:ring-zinc-400.
 * Ahora: chips inactivos neon, selects neon-input. Charts ya usaban useChartColors + glow.
  ...
  return (
    <div className={CARD_CLASS}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
        <p className="text-[11px] text-zinc-500 font-medium">Actividad por día del mes · barras + tendencia</p>
      ...
      {cargando ? (
        ...
        <div className="h-[240px] flex items-center justify-center">
          <p className="text-xs text-zinc-500">Sin actividad en {MESES[mesSel - 1]} {anioSel}</p>
        </div>
      ) : (
