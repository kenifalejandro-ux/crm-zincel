          ...
          {selected ? (
            <div className="border border-zinc-200 rounded-xl p-3 space-y-3">
              ...
              <div className="flex items-center justify-between">
                <p className="text-[13px] font-bold text-zinc-800 capitalize">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-zinc-50 rounded-lg px-2.5 py-2">
                  <p className="text-[9px] text-zinc-400 uppercase">Empresas</p>
                  <p className="text-[20px] font-bold text-zinc-800">{selected.total}</p>
                </div>
                <div className="bg-zinc-50 rounded-lg px-2.5 py-2">
                  <p className="text-[9px] text-zinc-400 uppercase">% del total</p>
            ...
            <div className="border border-dashed border-zinc-200 rounded-xl flex items-center justify-center h-36">
            ...
            <div className="space-y-1">
              {datosValidos.slice(0, 6).map((d, i) => (
                ...
                >
                  ...
                  <span className="text-[10px] text-zinc-700 flex-1 truncate capitalize">
                    {d.zona.replace(/_/g, " ")}
                  </span>
                  <span className="text-[10px] font-bold text-zinc-800">{d.total}</span>
                </div>
              ))}
            </div>
          </div>
