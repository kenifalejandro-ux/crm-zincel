...
const COLORES_CIUDAD = [
  COLORS.dark, COLORS.mutedDark, COLORS.primary, COLORS.dark,
  COLORS.mutedDark, COLORS.primary, COLORS.dark, COLORS.mutedDark,
];
  ...
  return (
    <div className={CARD_CLASS}>
      <h2 className={HEADER_CLASS}>
        <MapPin size={14} className="mr-2.5 text-rose-500" strokeWidth={2} />
        Prospectos por Ciudad
      </h2>

      {datos.length === 0 ? (
        <p className="text-[12px] text-zinc-600 text-center py-6 font-medium">Sin datos</p>
      ) : (
            ...
            return (
              <div key={i}>
                <div className="flex justify-between items-center mb-1.5">
                  <span className="text-[12px] font-medium text-zinc-700 capitalize">{item.ciudad}</span>
