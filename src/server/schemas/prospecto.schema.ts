...
export const crearProspectoSchema = z.object({
  ...
  calidad_lead:     z.enum(["sin_calificar","calificado","no_calificado"]).default("sin_calificar"),
  campana_origen:   z.string().max(200).nullable().optional(),
  estado_lead:      z.enum(["nuevo","por_gestionar","interesado","no_interesado","no_contesta","volver_a_llamar","ocupado_en_reunion","prometio_llamar","buzon_de_voz","fuera_de_servicio","numero_equivocado","ya_tiene_proveedor","baja_de_oficio","solicita_informacion","suspension_temporal","perdida","no_habido","venta_ganada"]).default("por_gestionar"),
