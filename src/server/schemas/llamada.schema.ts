...
export const crearLlamadaSchema = z.object({
  ...
  resultado:         z.enum(["interesado","solicita_informacion","no_interesado","no_contesta","volver_a_llamar","buzon_de_voz","fuera_de_servicio","numero_equivocado","ya_tiene_proveedor","baja_de_oficio","suspension_temporal"]).optional(),
