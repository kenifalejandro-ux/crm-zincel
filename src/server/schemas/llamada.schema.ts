...
export const crearLlamadaSchema = z.object({
  ...
  resultado:         z.enum(["interesado","solicita_informacion","no_interesado","no_contesta","volver_a_llamar","ocupado_en_reunion","prometio_llamar","buzon_de_voz","fuera_de_servicio","numero_equivocado","ya_tiene_proveedor","baja_de_oficio","suspension_temporal","no_habido","perdida","venta_ganada"]).optional(),
  ...
  intentos:          z.number().int().min(1).max(20).default(1),
});
